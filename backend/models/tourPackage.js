...
const tourPackageSchema = new Schema({
    ...
    pCreateDate : {
        type : String,
        required : [true, "Tour Package Create date is required!"],
        default : Date.now,
        validate : {
            validator : function (value) {
                return value == Date.now
            },
            message : "Tour Package Create Date must be today's date"
        }
    },
    ...
    packagePrice : {
        ...
        validate : {
            ...
            message : "Tour Package price should be greater than or equal 0"
        }
    },
