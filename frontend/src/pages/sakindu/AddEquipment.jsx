...
function AddEquipment() {
    ...
    const [equipmentId, setPackageId] = useState("");
    const [equipmentName, setPackage_Title] = useState("");
    const [equipmentType, setEquipmentType] = useState("");
    const [equipmentDescription, setPackageDes] = useState("");
    const [equipmentImage, setEquipmentImage] = useState(null);
    const [equipmentPrice, setPrice] = useState("");
    const [equipmentQuantity, setEuipmentQuantity] = useState("");
    ...
    function addEquipment(e){
        ...
        axios.post("http://localhost:5000/Equipment/add", formData).then(() => {
    ...
    return (
        ...
        <section className="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-20">
          ...
          <form>
            <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              ...
              <div>
                <label className="text-white dark:text-gray-200" htmlFor="passwordConfirmation">Equipment Price</label>
                <input
      ...
      <div className="mb-4">
        ...
        <input
          ...
          max="100"
          value={Qty}
          onInput={(e) => updateQty(e.target.value)}
        />
      </div>
      <div className="flex justify-between text-gray-500">
        <span id="minQty">{Qty}</span>
